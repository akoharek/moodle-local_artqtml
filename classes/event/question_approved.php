...
/**
 * question_approved event (technical annex 7.1, Jov-016).
 *
...
class question_approved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_question_approved', 'local_artqtml');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' approved draft question '{$this->objectid}' " .
            "(question bank entry '{$this->other['questionbankid']}').";
    }
}
