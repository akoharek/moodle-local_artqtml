...
/**
 * question_deleted event (technical annex 7.1, Jov-015).
 *
...
class question_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_question_deleted', 'local_artqtml');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' deleted draft question '{$this->objectid}'.";
    }
}
